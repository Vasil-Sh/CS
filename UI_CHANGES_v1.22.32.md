# UI Changes for v1.22.32 → current dev

## Instructions
1. CREATE a new file: `src/components/StrategyKpiCard.tsx` (code below)
2. REPLACE `src/components/StrategyOverviewHeader.tsx` entirely (code below)
3. `src/lib/cardStyles.ts` — NO changes (identical in both branches)
4. `src/pages/Strategy.tsx` — NO changes (already has `currentUser` prop)

---

## FILE 1: `src/components/StrategyKpiCard.tsx` (NEW FILE — CREATE IT)
...
## FILE 2: `src/components/StrategyOverviewHeader.tsx` (REPLACE ENTIRE FILE)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
        ...
        <div
          className="bg-white/60 backdrop-blur-sm rounded-[32px] border-2 border-[#E8E6DC] shadow-[0_4px_16px_rgba(0,0,0,0.06)] h-full flex flex-col overflow-hidden"
        >
          {/* Header: icon + name */}
          ...
          {activeStrategy ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-7 py-12 text-center">
              ...
              <p className="text-base font-semibold text-[#111827] mb-2">
