              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex items-end gap-3 mb-2">
                    <div className="flex-1 bg-emerald-50 rounded-xl px-3 py-2 border border-emerald-200">
                      ...
                      <div className="text-lg font-bold text-emerald-700">
                        {bestMonth ? <><span>{bestMonth.profit >= 0 ? "+" : ""}</span><NumberTicker value={Math.round(bestMonth.profit)} /><span> ₴</span></> : "—"}
                      </div>
                    ...
                    <div className="flex-1 bg-red-50 rounded-xl px-3 py-2 border border-red-200">
                      ...
                      <div className="text-lg font-bold text-red-500">
                        {worstMonth ? <><span>{worstMonth.profit >= 0 ? "+" : ""}</span><NumberTicker value={Math.round(worstMonth.profit)} /><span> ₴</span></> : "—"}
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                      ...
                      <div className={`text-sm font-bold ${avgMonthlyProfit >= 0 ? "text-gray-900" : "text-red-500"}`}>
                        {avgMonthlyProfit >= 0 ? "+" : ""}<NumberTicker value={Math.round(avgMonthlyProfit)} /> ₴
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-4 mb-2">
                    <div className="text-4xl font-bold text-gray-900 tracking-tight">{avgOdds > 0 ? avgOdds.toFixed(2) : "—"}</div>
                    <AnimatedCircularProgressBar
                      max={100}
                      min={0}
                  ...
                  <div className="text-xs text-center text-gray-400 mb-2">середній коефіцієнт • Winrate</div>
