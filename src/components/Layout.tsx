          ...
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-8">
              ...
              <li className="mt-auto space-y-3">
                <a
                  href="https://t.me/matchiq_channel"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-start gap-3 px-5 py-4 text-[#229ED9] bg-[#E8F4FD] border-2 border-[#229ED9] rounded-[24px] font-normal text-base transition-all duration-300 hover:bg-[#229ED9] hover:text-white hover:shadow-[0_4px_16px_rgba(34,158,217,0.3)]"
                >
