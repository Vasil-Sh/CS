...
export default function MatchRow({
  ...
  return (
    <tr
      className={`border-b border-gray-100 hover:bg-gray-50 transition-all duration-200 ${isFinished ? "opacity-80" : ""} ${isOngoing ? "border-t-2 border-t-green-400 bg-green-50/20" : ""} ${isSelected ? "bg-blue-50/60 !border-l-blue-500" : ""}`}
    >
