  ...
  return (
    <section className="relative py-24 px-6 bg-[#1a1a2e] overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#447afc] rounded-full mix-blend-multiply filter blur-3xl" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <Link to={buttonHref} className="inline-flex items-center gap-2 px-10 py-5 rounded-2xl bg-gradient-to-r from-[#447afc] to-[#7C3AED] text-white font-bold text-lg hover:shadow-[0_8px_32px_rgba(68,122,252,0.4)] transition-all">
