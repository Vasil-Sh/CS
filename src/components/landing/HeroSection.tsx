  ...
  return (
    <section aria-label="Головний екран" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 w-72 h-72 bg-[#447afc] rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
        ...
        <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-[#22C55E] rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000" />
      </div>
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
          <span className="bg-gradient-to-r from-[#447afc] to-[#7C3AED] bg-clip-text text-transparent">{heading}</span>
        </h1>
        <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">{subheading}</p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/login" className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-[#447afc] to-[#7C3AED] text-white font-semibold text-lg hover:shadow-[0_8px_32px_rgba(68,122,252,0.4)] transition-all">
