...
export default function ExpressDetailsModal({
  ...
  const totalOdds = parsedEvents.reduce(
    (acc, event) => acc * parseFloat(event.odds),
    1,
  );
      ...
      <DialogContent className="sm:max-w-[640px] rounded-3xl border border-gray-100 bg-white p-0 gap-0 max-h-[90vh] overflow-y-auto [&>button]:hidden">
        ...
        <div className="space-y-4 p-6 bg-gray-100">
          ...
          <Collapsible
            ...
            className="bg-white/90 rounded-2xl border border-gray-200 overflow-hidden shadow-sm"
          >
                    ...
                    >
                      <div className="space-y-2.5">
                        ...
                        <div className="space-y-1 bg-gray-50 rounded-xl p-3 border border-gray-100">
                          ...
                          <p className="text-xs text-gray-900">
                            <span className="text-gray-400">Вибір:</span>{" "}
