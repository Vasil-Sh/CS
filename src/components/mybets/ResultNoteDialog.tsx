      ...
      <DialogContent className="rounded-3xl max-w-lg border border-[#E5E7EB] p-0 gap-0">
        <DialogHeader className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-xl font-semibold text-[#111827]">Чому такий результат?</DialogTitle>
          </div>
        </DialogHeader>
        ...
        <div className="px-6 pb-6 pt-4 space-y-3 bg-[#F3F4F6]">
            ...
            <div className="text-center">
              <div className="flex flex-col items-center px-5 py-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm">
                <div className="flex items-center justify-center gap-1 w-full">
                  <span className="text-base font-semibold text-[#111827] truncate max-w-[200px]">
                ...
                <p className="text-sm text-[#6B7280] mt-2">
                  Позначити як <strong className={pendingAction.result === "Win" ? "text-[#22C55E]" : "text-[#DC2626]"}>
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={onConfirm} className="flex-1 rounded-2xl bg-[#447afc] hover:bg-[#3568d4]">
              Зберегти
            </Button>
          </div>
        </div>
