              ...
              <table className="w-full border-collapse table-fixed">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    <th
                      className="text-center px-2.5 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors w-[70px]"
                    ...
                    <th className="text-left px-3 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-l border-gray-200">
                      Матч
                    </th>
                    <th className="text-center px-2.5 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-l border-gray-200 w-[80px]">
                      Сума
                    </th>
                    <th
                      className="text-center px-2.5 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors border-l border-gray-200 w-[60px]"
                    ...
                    <th
                      className="text-center px-2.5 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors border-l border-gray-200 w-[80px]"
                    ...
                    <th className="text-center px-2 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-l border-gray-200 w-[60px]">
                      Статус
                    </th>
                    <th className="text-center px-2 py-2.5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-l border-gray-200 w-[60px]">
                      Дії
                ...
                <tbody>
                  {paginatedBets.map((bet) => {
                    ...
                    const team1Match = matchParts[0] || bet.team1 || "";
                    const team2Match = matchParts[1] || bet.team2 || "";
                    const betTypeParts = bet.betType.split(" - ");
                    const betTypeLabel = getBetTypeLabel(
                      betTypeParts[0],
                      bet.format,
                    );
                    const selection = betTypeParts.slice(1).join(" - ") || "";
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5 border-l border-gray-100">
                          <div className="min-w-0 space-y-0.5">
                            ...
                            {!isExpress && (
                              <>
                                <div className="text-xs text-blue-600 font-medium leading-tight pt-0.5">
                                  {betTypeLabel}
                                </div>
                                {selection && (
                            ...
                            {isExpress && (
                              <div className="flex items-center gap-1.5 pt-1">
                                <Badge className="rounded-md bg-amber-100 text-amber-600 border-0 font-semibold text-xs px-2 py-0.5">
                        ...
                        <td className="px-2.5 py-2.5 text-center border-l border-gray-100">
                        ...
                        <td className="px-2.5 py-2.5 text-center border-l border-gray-100">
                          ...
                          displayProfit !== null ? (
                            <span
                              className={`text-sm font-bold whitespace-nowrap ${displayProfit >= 0 ? "text-green-500" : "text-red-500"}`}
                            >
                              {displayProfit >= 0 ? "+" : ""}
                        ...
                        <td className="px-2 py-2.5 text-center border-l border-gray-100">
                          <Badge
                            className={`rounded-full border-0 font-semibold text-xs px-2.5 py-1 ${isWin ? "bg-green-100 text-green-600" : isLoss ? "bg-red-100 text-red-600" : "bg-amber-100 text-amber-600"}`}
                          >
                            {isWin ? "Виграш" : isLoss ? "Програш" : "Очік."}
                          </Badge>
                        </td>
                        <td className="px-2 py-2.5 text-center border-l border-gray-100">
                          <div className="flex items-center justify-center gap-1 flex-wrap">
                            {isPending && (
                              <>
                                <button
                                  ...
                                  className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 hover:bg-green-100 hover:border-green-300 text-green-600 transition-all"
                                  title="Виграш"
                                >
                                  <CheckCircle
                                ...
                                <button
                                  ...
                                  className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 hover:bg-red-100 hover:border-red-300 text-red-600 transition-all"
                                  title="Програш"
                                >
                                  <XCircle
                                    className="h-3.5 w-3.5"
                            ...
                            <button
                              ...
                              className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 hover:bg-purple-50 hover:border-purple-300 text-purple-600 transition-all"
                              title="Деталі"
                            >
                            ...
                            {bet.notes && (
                              <button
                                ...
                                className="flex items-center justify-center w-7 h-7 rounded-lg bg-gray-50 border border-gray-200 hover:bg-blue-50 hover:border-blue-300 text-blue-500 transition-all"
                                title="Нотатки"
                              >
                                <FileText
                                  className="h-3 w-3"
                            ...
                            <button
                              ...
                              className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 hover:bg-blue-50 hover:border-blue-300 text-blue-500 transition-all"
                              title="Поділитися"
                            >
