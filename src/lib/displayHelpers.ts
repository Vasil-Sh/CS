...
const MAP_BET_TYPES: BetTypeGroup[] = [
  ...
  },
  {
    category: 'Фора',
    options: [
      { value: 'HC_T1-2.5', label: '-2.5 раундів' },
      { value: 'HC_T2+2.5', label: '+2.5 раундів' },
      { value: 'HC_T1+2.5', label: '+2.5 раундів' },
      { value: 'HC_T2-2.5', label: '-2.5 раундів' },
      { value: 'HC_T1-3.5', label: '-3.5 раундів' },
      { value: 'HC_T2+3.5', label: '+3.5 раундів' },
      { value: 'HC_T1+3.5', label: '+3.5 раундів' },
      { value: 'HC_T2-3.5', label: '-3.5 раундів' },
      { value: 'HC_T1-4.5', label: '-4.5 раундів' },
      { value: 'HC_T2+4.5', label: '+4.5 раундів' },
      { value: 'HC_T1+4.5', label: '+4.5 раундів' },
      { value: 'HC_T2-4.5', label: '-4.5 раундів' },
      { value: 'HC_T1-5.5', label: '-5.5 раундів' },
      { value: 'HC_T2+5.5', label: '+5.5 раундів' },
      { value: 'HC_T1+5.5', label: '+5.5 раундів' },
      { value: 'HC_T2-5.5', label: '-5.5 раундів' },
    ],
  },
