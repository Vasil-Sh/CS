...
const T: TranslationMap = {
  ...
  "app.helpDesc": {
    uk: "Є питання або пропозиції? Напиши нам в Telegram",
    en: "Questions or suggestions? Write us on Telegram",
  },
  ...
  "nav.riskyTeams": { uk: "Ризиковані команди", en: "Risky Teams" },
  ...
  "analytics.profitPositive": {
    uk: "Позитивна динаміка",
    en: "Positive trend",
  },
  "analytics.profitNegative": {
    uk: "Негативна динаміка",
    en: "Negative trend",
  },
  "analytics.forAllTime": { uk: "за весь час", en: "all time" },
  "analytics.pendingResult": {
    uk: "Очікують результату",
    en: "Awaiting result",
  },
  ...
  "analytics.clearConfirm": {
    uk: "Ви впевнені, що хочете очистити всі дані аналітики? Ця дія незворотна.",
    en: "Are you sure you want to clear all analytics data? This is irreversible.",
  },
  ...
  "balance.noCompleted": {
    uk: "Поки немає завершених ставок",
    en: "No completed bets yet",
  },
  "balance.atPeak": {
    uk: "Банк на максимумі — це найкращий результат! 🔥",
    en: "Bank at all-time high — best result! 🔥",
  },
  "balance.stable": {
    uk: "Банк стабільний, близько до найкращого результату",
    en: "Bank stable, close to best result",
  },
  "balance.dipping": { uk: "Банк зменшився на", en: "Bank down by" },
  "balance.dippingSuffix": { uk: "від найкращого", en: "from peak" },
  "balance.falling": {
    uk: "Банк значно просів — на",
    en: "Bank significantly down —",
  },
  "balance.fallingSuffix": { uk: "від максимуму", en: "from max" },
  "balance.adviceAdd": {
    uk: "Додавай записи про ставки — цей блок покаже твій прогрес",
    en: "Add bet records — this block will show your progress",
  },
  "balance.adviceGood": {
    uk: "Ти на правильному шляху. Продовжуй!",
    en: "You're on the right track. Keep going!",
  },
  "balance.adviceStable": {
    uk: "Усе добре. Дотримуйся стратегії.",
    en: "All good. Stick to your strategy.",
  },
  "balance.adviceDipping": {
    uk: "Можливо варто зменшити ставки або зробити паузу",
    en: "Consider reducing stakes or taking a break",
  },
  "balance.adviceFalling": {
    uk: "Радимо зменшити ставки та переглянути стратегію",
    en: "We recommend reducing stakes and reviewing your strategy",
  },
  ...
  "mybets.search": {
    uk: "Пошук за матчем, командою, грою…",
    en: "Search by match, team, game…",
  },
  ...
  "profile.storageSize": {
    uk: "Розмір даних у localStorage",
    en: "Data size in localStorage",
  },
  "profile.storageDesc": {
    uk: "Усі дані додатку зберігаються локально у вашому браузері",
    en: "All app data is stored locally in your browser",
  },
  "profile.jsonExport": {
    uk: "Повний бекап всіх даних",
    en: "Full backup of all data",
  },
  "profile.jsonExportDesc": {
    uk: "Експортує всі ваші дані (ставки, команди, стратегії, цілі, налаштування) в один JSON файл. Використовуйте для збереження копії або перенесення на інший пристрій.",
    en: "Exports all your data (bets, teams, strategies, goals, settings) into one JSON file. Use to save a copy or transfer to another device.",
  },
  "profile.jsonBtn": {
    uk: "Завантажити повний бекап",
    en: "Download Full Backup",
  },
  "profile.jsonCreating": {
    uk: "Створення бекапу...",
    en: "Creating backup...",
  },
  "profile.csvExport": { uk: "Експорт ставок у CSV", en: "Export Bets to CSV" },
  "profile.csvExportDesc": {
    uk: "Вивантажує ваші ставки у формат CSV для аналізу в Excel або Google Sheets.",
    en: "Exports your bets in CSV format for analysis in Excel or Google Sheets.",
  },
  "profile.csvBtn": { uk: "Завантажити CSV", en: "Download CSV" },
  "profile.import": { uk: "Відновити з бекапу", en: "Restore from Backup" },
  "profile.importDesc": {
    uk: "Завантажте раніше створений файл бекапу для відновлення всіх даних.",
    en: "Upload a previously created backup file to restore all data.",
  },
  "profile.importBtn": { uk: "Обрати файл бекапу", en: "Choose backup file" },
  "profile.importWarning": {
    uk: "Увага: відновлення з бекапу замінить усі поточні дані.",
    en: "Warning: restoring from backup will replace all current data.",
  },
  "profile.noBetsForCsv": {
    uk: "Немає ставок для експорту",
    en: "No bets to export",
  },
  ...
  "landing.tagline": {
    uk: "Розумний беттінг з AI аналітикою",
    en: "Smart betting with AI analytics",
  },
  ...
  "404.desc": {
    uk: "Сторінка, яку ви шукаєте, не існує.",
  ...
  "common.backupCreated": {
    uk: "Повний бекап створено!",
    en: "Full backup created!",
  },
  "common.backupError": {
    uk: "Помилка створення бекапу",
  ...
  "common.notBackup": {
    uk: "Файл не є бекапом MatchIQ.",
    en: "File is not a MatchIQ backup.",
  },
};
...
let currentLang: Lang = (() => {
  try {
    return (localStorage.getItem("matchiq_lang") as Lang) || "uk";
  } catch {
    return "uk";
  }
})();
...
export function setLang(lang: Lang) {
  currentLang = lang;
  try {
    localStorage.setItem("matchiq_lang", lang);
  } catch {
    /* ignore */
  }
  // Sync to API
